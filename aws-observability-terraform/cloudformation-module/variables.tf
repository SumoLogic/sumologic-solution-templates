...
variable "Section1aSumoLogicDeployment" {
  type        = string
  description = "Enter au, ca, ch, de, eu, esc, fed, jp, kr, us1 or us2. Visit https://help.sumologic.com/APIs/General-API-Information/Sumo-Logic-Endpoints-and-Firewall-Security"
  validation {
    condition = contains([
      "au",
      "ca",
    ...
    error_message = "Argument \"Section1aSumoLogicDeployment\" must be either \"au\", \"ca\", \"ch\", \"de\", \"eu\", \"esc\", \"jp\", \"us2\", \"kr\", \"fed\" or \"us1\"."
  }
}
