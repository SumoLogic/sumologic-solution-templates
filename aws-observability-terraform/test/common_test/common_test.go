...
func TestCommonAll(t *testing.T) {
	...
	cloudTrailSNSSubscription := terraform.Output(t, terraformOptions, "aws_sns_topic_policy_common_name")
	...
	iamRoleCWLambdaLogs := terraform.Output(t, terraformOptions, "aws_iam_policy_cw_logs_source_lambda_logs_name")
