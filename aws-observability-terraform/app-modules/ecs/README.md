...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ecs_module"></a> [ecs\_module](#module\_ecs\_module) | SumoLogic/sumo-logic-integrations/sumologic//sumologic | 1.0.20 |
...
| <a name="input_environment"></a> [environment](#input\_environment) | Enter au, ca, ch, de, eu, esc, fed, jp, kr, us1 or us2. Visit https://help.sumologic.com/APIs/General-API-Information/Sumo-Logic-Endpoints-and-Firewall-Security | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_sumologic_content"></a> [sumologic\_content](#output\_sumologic\_content) | This output contains ecs App. |
| <a name="output_sumologic_field"></a> [sumologic\_field](#output\_sumologic\_field) | This output contains fields required for ecs app. |
| <a name="output_sumologic_field_extraction_rule"></a> [sumologic\_field\_extraction\_rule](#output\_sumologic\_field\_extraction\_rule) | This output contains Field Extraction rules required for ecs app. |
