...
# For SUMOLOGIC_ENV, provide one from the list : au, ca, ch, de, eu, esc, jp, us2, fed or us1. For more information on Sumo Logic deployments visit https://help.sumologic.com/APIs/General-API-Information/Sumo-Logic-Endpoints-and-Firewall-Security"
...
if ! [[ "$SUMOLOGIC_ENV" =~ ^(au|ca|de|eu|esc|jp|us2|fed|us1|kr)$ ]]; then
