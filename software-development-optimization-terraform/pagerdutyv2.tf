...
# This script creates WebhooksV2 to Sumo Logic in Pagerduty Services.
# Configure the Pagerduty credentials in the pagerdutyv2.auto.tfvars.
...
resource "pagerduty_service_integration" "sumologic_v2_service" {
