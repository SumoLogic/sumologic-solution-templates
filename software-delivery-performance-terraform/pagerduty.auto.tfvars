...
pagerduty_services_pagerduty_webhooks     = ["<SERVICE1>","<SERVICE2>"] #  Please replace <SERVICE1> and <SERVICE2> (including brackets) with your Pagerduty service IDs. You can get these from the URL after opening a specific service. These are used for Pagerduty to Sumo Logic webhooks.
