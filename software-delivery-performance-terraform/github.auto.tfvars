...
create_github_org_webhook = 0 # Needs to be 0 or 1. These events will be in addition to repository events.
...
github_org_events = ["check_run","check_suite","commit_comment","content_reference","create","delete","deploy_key","deployment",
"deployment_status","fork","github_app_authorization",
"gollum","installation","installation_repositories","issue_comment","issues","label","marketplace_purchase","member",
...
"security_advisory","sponsorship","star","status","team","team_add","watch"]