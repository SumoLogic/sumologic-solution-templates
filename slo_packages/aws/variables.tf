...
variable "environment" {
  ...
  validation {
    condition = contains([
      "US1",
    "us1","US2","us2","AU","au","CA","ca","DE","de","EU","eu","ESC","esc","FED","fed","JP","jp","IN","in", "KR", "kr"], var.environment)
    error_message = "Argument \"environment\" must be one of \"us1\",\"us2\",\"au\",\"ca\",\"de\",\"eu\",\"esc\", \"fed\",\"jp\",\"kr\",\"in\"."
  }
}
variable "folder" {
  type = string
