...
aws s3 cp s3://sumologic-appdev-aws-sam-apps/aws-observability-versions/v2.3.1/sumologic_observability.master.template.yaml sumologic_observability_template.yaml
